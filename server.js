...
function gatePage() {
  return '<!DOCTYPE html><html lang="fr"><head><meta charset="utf-8">'
    ...
    + 'background:#f4f0e8;color:#1f2120;font-family:-apple-system,Segoe UI,Roboto,Helvetica,Arial,sans-serif;padding:24px}'
    ...
    + '.logo .amp{color:#c59d5f}.sub{color:#5a5550;font-size:.9rem;margin-bottom:22px}'
    + 'input{width:100%;padding:14px 16px;border-radius:12px;border:2px solid #e8e2d9;background:#fff;color:#1f2120;'
    + 'font-size:1.1rem;text-align:center;letter-spacing:.1em;font-family:inherit}'
    + 'button{width:100%;margin-top:12px;padding:14px;border:0;border-radius:12px;background:#c59d5f;color:#1f2120;'
    + 'font-weight:800;font-size:1rem;cursor:pointer;font-family:inherit}'
    + '.err{color:#bf272d;font-size:.85rem;min-height:1.2em;margin-top:10px}</style></head><body><div class="card">'
